                                ...
                                <MDBTableBody>
                                    {nailpedicare.map((nailpedicare, key) => (
                                        <tr className="bg-light">
                                            ...
                                            <td>
                                                <button size='lg' type="button" class="btn btn-dark" color="dark" style={{ fontWeight: "bold", fontSize: "12px" }} onClick={() => add(nailpedicare.name, nailpedicare.type, nailpedicare.date, nailpedicare.price)}>ADD</button>
                                            </td>
                                        </tr>
                                    ))}
                                </MDBTableBody>
