...
export default class SponsorReport extends Component {
...
exportToExcel = () => {
    ...
    const ws = XLSX.utils.json_to_sheet(sponsor);
    XLSX.utils.book_append_sheet(wb, ws, "Sponsor Data");
    XLSX.writeFile(wb, "sponsor.xlsx");
  }
  //gather outputs
  render() {
    return (
        ...
        <h4 className="text-uppercase  d-letter-spacing fw-bold" style={{ color: 'black' }}><i class="fa-solid fa-folder-open"></i> Sponsor Management Reports</h4>
        <hr/>
